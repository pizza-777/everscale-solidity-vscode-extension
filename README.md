...
TON Solidity is the language used in FreeTON blockchain to create smart contracts, this extension provides: 

* Syntax highlighting
* Snippets
* Auto compilation of the current contract: checkinig for errors and warnings on the fly. 
